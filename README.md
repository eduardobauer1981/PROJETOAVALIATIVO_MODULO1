...
# Nome do software: SENSORES_MAQUINA

# Descrição do problema que resolve

Atuando como um Cientista de Dados foi estruturado um Pipeline Preditivo completo aplicado à indústria 4.0.
...
* Criação deste arquivo readme.md e do arquivo requirements.txt

* O codigo será executo no arquivo "projeto_maquinas.ipynb"
